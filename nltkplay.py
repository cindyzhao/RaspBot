...
pairs = (
  ...
  ("There are three ways in which a ruler can bring misfortune upon his army.",
   ...
   "By employing the officers of his army without discrimination, through ignorance of the military principle.",
   "There are five essentials for victory",
...
def respondtweet(question):
    return (suntsu_chatbot.respond(question))
